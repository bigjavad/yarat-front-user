    ...
    return (
        <div className="section-full bg-img-fix content-inner bg-gray" id="project">
            <div className="container">
                <div className="section-head text-center head-style-2 wow fadeIn" data-wow-duration="2s"
                     data-wow-delay="0.2s">
                    ...
                    <p>
                        در گالری یارات، مجموعه‌ای از خودروهای متنوع و خدمات تخصصی تعمیر و نگهداری خودرو را به نمایش
                        می‌گذاریم.
                ...
                <div className="site-filters style-1 clearfix center m-b40">
                    <ul className="filters" data-toggle="buttons">
                        <li onClick={() => gelleryfilterBtn('all')}
                            className={`btn ${addactive === 'all' ? 'active' : ''}`}>
                            <input type="radio"/>
                            <Link href={'#'} className="site-button-secondry wow fadeInUp"><span>نمایش همه</span></Link>
                        </li>
                        <li onClick={() => gelleryfilterBtn('two')}
                            className={`btn ${addactive === 'two' ? 'active' : ''}`}>
                            <Link href={'#'}
                                  className="site-button-secondry wow fadeInUp"><span>باگی دو نفره</span></Link>
                        </li>
                        <li onClick={() => gelleryfilterBtn('four')}
                            className={`btn ${addactive === 'four' ? 'active' : ''}`}>
                            <Link href={'#'}
                                  className="site-button-secondry wow fadeInUp"><span>باگی چهار نفره</span></Link>
                        </li>
                        <li onClick={() => gelleryfilterBtn('eight')}
                            className={`btn ${addactive === 'eight' ? 'active' : ''}`}>
                            <Link href={'#'}
                                  className="site-button-secondry wow fadeInUp"><span>باگی هشت نفره</span></Link>
                        </li>
                        <li onClick={() => gelleryfilterBtn('twelve')}
                            className={`btn ${addactive === 'twelve' ? 'active' : ''}`}>
                                ...
                                <div data-exthumbimage={image.img} data-src={image.img} className="figure" key={index}>
                                    <li className="office card-container">
                                        <div className="dlab-box dlab-gallery-box">
                                            <div
                                                className="dlab-media dlab-img-overlay1 dlab-img-effect zoom-slow dlab-img-effect zoom">
                                                <img src={image.img} alt={image.category}/>
                                                <div className="overlay-bx">
                                                    <div className="overlay-icon">
                                                        <span
                                                            className="fas fa-image icon-bx-xs check-km lightimg m-l10"
