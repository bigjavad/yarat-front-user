            ...
            <div className="section-content" style={{ overflow: 'hidden' }}>
                ...
                >
                    ...
                    <div className="testimonial-pagination text-center m-t50">
                        <div className="btn-prev swiper-button-prev7 cursorPointer" onClick={() => { swiperRef.current.swiper.slidePrev() }}><FaCaretRight /></div>
                        <div className="btn-next swiper-button-next7 cursorPointer" onClick={() => { swiperRef.current.swiper.slideNext() }}><FaCaretLeft /></div>
                    </div>
                </Swiper>
            </div >
        </>
