...
const testimonial = [
    {
        ...
        name: "مهدی حسینی",
        desc: "با یارات موتورز تجربه رانندگی در کویر برام فراموش‌نشدنی شد. باگی‌ها فوق‌العاده مقاوم و قدرتمند هستند و خدمات پس از فروش هم همیشه همراه ما بود."
    },
    {
    ...
    },
    {
        ...
        name: "امیر رضا نادری",
        desc: "پشتیبانی تیم یارات موتورز بی‌نظیر بود. از مراحل سفارش تا تحویل، همه چیز سریع و بدون مشکل انجام شد."
    },
    {
        img: '/assets/images/testimonials/pic2.jpg',
        name: "نرگس عباسی",
    ...
    },
    {
        img: '/assets/images/testimonials/pic3.jpg',
        name: "مهسا رضوی",
        desc: "طراحی زیبا و بدنه مقاوم باگی‌ها باعث شد همه دوستام عاشقش بشن. خرید از یارات موتورز یک تجربه حرفه‌ای بود."
    },
];
const Testimonial = () => {
