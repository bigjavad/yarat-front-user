          ...
          <div className="container">
            <div className="row align-items-center fb-inner spno">
              <div className="col-12 text-center">
                <span className="copyright-text">Copyright © 2023 <Link href="https://dexignlab.com/" className="text-primary" target="_blank">DexignLabs</Link> All rights reserved.</span>
              </div>
            </div>
          </div>
        </div>
