...
function Page() {
    ...
    const imageCard = [
        {
            location: 1,
            img: <svg width="94" height="78" viewBox="0 0 94 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                ...
                <defs>
                    <linearGradient id="paint0_linear" x1="22.9458" y1="0.170653" x2="83.851" y2="99.1745"
            ...
            img: <svg width="94" height="78" viewBox="0 0 94 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient id="paint0_linear1" x1="22.9458" y1="0.170653" x2="83.851" y2="99.1745"
                                    gradientUnits="userSpaceOnUse">
                        <stop stopColor="#EE3131"/>
                        <stop offset="1" stopColor="#FF8E8E"/>
                    </linearGradient>
            ...
            img: <svg width="94" height="78" viewBox="0 0 94 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient id="paint0_linear2" x1="22.9458" y1="0.170653" x2="83.851" y2="99.1745"
                                    gradientUnits="userSpaceOnUse">
                        <stop stopColor="#EE3131"/>
                        <stop offset="1" stopColor="#FF8E8E"/>
                    </linearGradient>
            ...
            img: <svg width="94" height="78" viewBox="0 0 94 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient id="paint0_linear3" x1="22.9458" y1="0.170653" x2="83.851" y2="99.1745"
                                    gradientUnits="userSpaceOnUse">
                        <stop stopColor="#EE3131"/>
                        <stop offset="1" stopColor="#FF8E8E"/>
                    </linearGradient>
    ...
    const carValueDetail = [
        {
            ...
            img:
                <svg enableBackground="new 0 0 32 32" height="60" width="60" id="Layer_1" version="1.1"
                     viewBox="0 0 32 32" space="preserve" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="calendar_1_">
                        <path
                            ...
                            fill="var(--primary)"/>
                        <rect fill="var(--primary)" height="3" width="4" x="7" y="12"/>
                        <rect fill="var(--primary)" height="3" width="4" x="7" y="17"/>
                        <rect fill="var(--primary)" height="3" width="4" x="7" y="22"/>
                        <rect fill="var(--primary)" height="3" width="4" x="14" y="22"/>
                        <rect fill="var(--primary)" height="3" width="4" x="14" y="17"/>
                        <rect fill="var(--primary)" height="3" width="4" x="14" y="12"/>
                        <rect fill="var(--primary)" height="3" width="4" x="21" y="22"/>
                        <rect fill="var(--primary)" height="3" width="4" x="21" y="17"/>
                        <rect fill="var(--primary)" height="3" width="4" x="21" y="12"/>
                    </g>
                </svg>
    ...
    return (
        <div>
            <div className="page-content bg-white">
                <CarListingBanner img={'/assets/images/gallery/2.webp'} title={'تعمیرات'}/>
                                    ...
                                    <div className="col-md-4 m-b30" key={index}>
                                        <div className="icon-bx-wraper left">
                                            <div className="icon-lg text-primary radius me-3">
                                                <Link href="#" className="icon-cell text-primary">{item.img}</Link>
                                            </div>
                ...
                <section className="content-inner-2">
                    <div className="container">
                        ...
                        <div className="map-bx-wraper">
                            <img src={IMAGE.mapPic1} className="map-img" alt="map"/>
                            {imageCard.map((i, ind) => (
                                <div onMouseEnter={() => {
                                    setActive(ind)
                                }}
